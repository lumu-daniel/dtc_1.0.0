...
public class NipsMerchantDetailsResponseArr {
    ...
    @Expose
    private MerchantDetailArr merchantDetail;
    ...
    public MerchantDetailArr getMerchantDetail() {
        return merchantDetail;
    }

    public void setMerchantDetail(MerchantDetailArr merchantDetail) {
